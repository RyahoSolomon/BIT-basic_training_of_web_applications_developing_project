document.addEventListener('DOMContentLoaded', function() {
    ...
    setTimeout(() => {
        ...
        setTimeout(() => {
            document.body.style.backgroundImage = "url('plot/background/013_official_road.png')"; // 替换为您的背景图片
    ...
    function onSlideImageTransitionEnd() {
        topLeftTexts[2].style.opacity = '1'; // 显示左上角文本
    ...
    function showNextText() {
        if (currentTextIndex === texts.length){
            window.location.href = "./chapter2_short_difference.html";
        }
        if (currentTextIndex < texts.length) {
